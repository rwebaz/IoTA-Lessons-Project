...
#
# Note. You will need to install a copy of the 'Gem Bundler' program onto your development machine using the following Terminal command:
#
# gem install bundler
#
...
#
# You may now install the local 'Jekyll server' program via the following Terminal command ...
#
# gem install jekyll v3.6.2
#
